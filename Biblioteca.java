...
//Crear estudiante
    ...
    public void agregarEstudiante(String nombre, String cedula, String telefono, String correo){
        Estudiante nuevoEstudiante = new Estudiante(nombre, cedula, correo, telefono);
